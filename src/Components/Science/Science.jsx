...
export default function Science() {
  ...
  async function fetchScienceNews() {
    try {
      ...
      let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=061c3bff2b054e75b3cca1dae6df9835`);
      console.log(data);
  ...
  if (error) {
    return (
      <div className={styles.errorContainer}>
        ...
        <button className={styles.retryButton} onClick={fetchScienceNews}>
          Try Again
        </button>
      </div>
    );
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <h1 className={styles.heroTitle}>Science News</h1>
              <p className={styles.heroSubtitle}>
                Explore the latest discoveries, research breakthroughs, and scientific advancements. 
                From space exploration to medical research and environmental science - stay informed about our evolving world.
              </p>
            </div>
          </div>
        </div>
