...
export default function Sports() {
  ...
  async function fetchSportsNews() {
    try {
      ...
      let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=061c3bff2b054e75b3cca1dae6df9835`);
      console.log(data);
  ...
  if (error) {
    return (
      <div className={styles.errorContainer}>
        ...
        <button className={styles.retryButton} onClick={fetchSportsNews}>
          Try Again
        </button>
      </div>
    );
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <h1 className={styles.heroTitle}>Sports News</h1>
              <p className={styles.heroSubtitle}>
                Stay updated with the latest scores, player transfers, and sporting events. 
                From the NFL to NBA, MLB to NHL, and everything in between - your source for all things sports.
              </p>
            </div>
          </div>
        </div>
