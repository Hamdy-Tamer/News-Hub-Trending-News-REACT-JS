...
export default function Entertainment() {
  ...
  async function fetchEntertainmentNews() {
    try {
      ...
      let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=061c3bff2b054e75b3cca1dae6df9835`);
      console.log(data);
  ...
  if (error) {
    return (
      <div className={styles.errorContainer}>
        ...
        <button className={styles.retryButton} onClick={fetchEntertainmentNews}>
          Try Again
        </button>
      </div>
    );
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <h1 className={styles.heroTitle}>Entertainment News</h1>
              <p className={styles.heroSubtitle}>
                Stay updated with the latest in movies, music, celebrities, and pop culture. 
                Get the scoop on award shows, new releases, and industry buzz.
              </p>
            </div>
          </div>
        </div>
