...
export default function Health() {
  ...
  async function fetchHealthNews() {
    try {
      ...
      let { data } = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=061c3bff2b054e75b3cca1dae6df9835`);
      console.log(data);
  ...
  if (error) {
    return (
      <div className={styles.errorContainer}>
        ...
        <button className={styles.retryButton} onClick={fetchHealthNews}>
          Try Again
        </button>
      </div>
    );
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              <h1 className={styles.heroTitle}>Health News</h1>
              <p className={styles.heroSubtitle}>
                Stay informed about the latest medical breakthroughs, wellness tips, and healthcare policies. 
                Your source for reliable information on medicine, fitness, nutrition, and mental health.
              </p>
            </div>
          </div>
        </div>
